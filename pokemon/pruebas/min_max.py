...
from pokemon.agenteP.agenteP import AgenteP, elegirMovimientoAleatorio, movimiento_en_base_a_mayor_daño, heuristica_difHP, generar_sucesores, NodoV2, minimax2, mini_max_recursivo, minimax_recursivov2, minimax_simplificado
import copy, random
...
nodo = NodoV2(estado=estado, profundidad=0)
#motor = Combate(estado)
print(" ==================== MiniMax =====================")
accion = minimax_simplificado(nodo, 4, None, 1, -float('inf'), float('inf'), pesos_mock)
